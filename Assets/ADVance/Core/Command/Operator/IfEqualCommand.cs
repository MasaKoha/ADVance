...
{
    public class IfEqualCommand : CommandBase
    {
        private readonly ScenarioBranchRegistry _branches;
        public override string CommandName => "IfEqual";
        ...
        public IfEqualCommand(ScenarioBranchRegistry branches)
        {
            _branches = branches;
        }
        ...
        public override async UniTask ExecuteCommandAsync(List<string> args)
        {
            ...
            if (args.Count >= 2)
            {
                ...
                result = _branches.Evaluate("Equal", resolvedArgs);
            }
