...
{
    public class IfLessCommand : CommandBase
    {
        private readonly ScenarioBranchRegistry _branches;
        public override string CommandName => "IfLess";
        ...
        public IfLessCommand(ScenarioBranchRegistry branches)
        {
            _branches = branches;
        }
        ...
        public override async UniTask ExecuteCommandAsync(List<string> args)
        {
            ...
            if (args.Count >= 2)
            {
                ...
                result = _branches.Evaluate("Less", resolvedArgs);
            }
